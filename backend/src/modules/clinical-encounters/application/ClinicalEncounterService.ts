...
export class ClinicalEncounterService {
  ...
  async finalizeEncounter(
    ...
    await new DentalCareService(this.prisma).finalizeCare(
      { clinicId, membershipId, userId: actorUserId, role: actorRole }, id, version
    );
    return this.getEncounterById(clinicId, id, actorRole);
  }
